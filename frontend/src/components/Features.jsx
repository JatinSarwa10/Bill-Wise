      ...
      <div className={featuresStyles.container}>
        <div className={featuresStyles.headerContainer}>
          ...
          <p className={featuresStyles.subtitle}>
            Aminimal, intelligent interface that focuses on what truly matters -
            create, send, and track invoices effortlessly while manitaining
        ...
        <div className={featuresStyles.bottomCtaContainer}>
            <div className={featuresStyles.bottomCtaButton}>
                <span className={featuresStyles.bottomCtaButtonText}> Expoler All features</span>
