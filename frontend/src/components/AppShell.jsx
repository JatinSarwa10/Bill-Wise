...
const AppShell = () => {
  ...
  const [collapsed, setCollapsed] = useState(() => {
    try {
      return localStorage.getItem("side_collapsed") === "true";
    } catch {
      return false;
    }
  });
            ...
            <div>
              <div
                className={`${appShellStyles.logoContainer} ${
                  collapsed ? appShellStyles.logoContainer : ""
                }`}
              >
                <Link to="/" className={appShellStyles.logoLink}>
                  ...
                  {!collapsed && (
                    <div className={appShellStyles.logoText}>
                      <span className={appShellStyles.logoText}>Bill-Wise</span>
            ...
            <div className={appShellStyles.userSection}>
              ...
              >
                {!collapsed ? (
                  ...
                  >
                    <LogoutIcon className="w-5 h-5 hover:scale-110" />
                  </button>
                )}
